...
/*!
    ...
    \date       2002/01/03    
 */  
// RCS-ID:      $Id: utils_controls_[with_time_controls].h,v 1.1 2002/09/28 19:41:58 robertoconnor Exp $
//----------------------------------------------------------------------------------------
...
public:
    ...
    //! Sets a time_control to the time specified in a configuration key string
    /*!
        \param target_time_control Pointer to the time_control.
     ...
     */
    static void set_time_control_to_configuration_time_string( time_control* target_time_control,
    ...
    /*!        
        \param time_configuration_key Key in configuration file holding the time.
        \param input_time_control Pointer to the time_control.
     */
    static void set_configuration_time_string_to_time_control( const wxString& time_configuration_key,
