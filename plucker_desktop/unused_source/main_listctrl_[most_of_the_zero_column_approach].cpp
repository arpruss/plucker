...
// RCS-ID:      $Id: main_listctrl_[most_of_the_zero_column_approach].cpp,v 1.1 2002/06/01 18:31:32 robertoconnor Exp $
...
{
    wxString channel_section_to_cast = channel_section;
